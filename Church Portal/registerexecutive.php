...
<div class="container">
    <h1 class="app-page-title">Executive Registration Page</h1>
    <hr class="mb-4">
    <div class="settings-section row">
        <div class="col-12 col-md-4">
        <h3 class="section-title">Fill the Membership Forms </h3>
        <h3 class="lead">The person in question herer, is a church exective, being a portfolio holder or an officer. If not <a href="registermember.php" class="link">click here</a> </h3>
        ...
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="./inc/exe_reg_form.php" enctype="multipart/form-data" >
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="select-input-3" class="form-label"  >Officer Status</label>
                            <select name="officer_status" class="form-control" id="select-input-3">
                        ...
                        <div class="mb-3">
                            <label for="select-input-4" class="form-label"  >Executive Position</label>
                            <select name="executive_position" class="form-control" id="select-input-4">
                                ...
                                <option value="Men's Fellowship Leader">Men's Fellowship Leader</option>
                                <option value="Wonmen's Fellowship Leader">Wonmen's Fellowship Leader</option>
                                <option value="Children Minstry Leader">Children Minstry Leader</option>
